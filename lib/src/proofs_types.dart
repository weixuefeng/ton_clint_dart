...
ProofsErrorCode.fromMap(str) {_value = str;}
}
...
ParamsOfProofBlockData({required dynamic block,}){

_block = ArgumentError.checkNotNull(block, 'ParamsOfProofBlockData block');
}
ParamsOfProofBlockData.fromMap(Map<String,dynamic> map){if (map.containsKey('block')&&(map['block']!=null)) {_block = map['block'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_block!=null) {map['block'] = _block;}
return map;
}
}
...
ParamsOfProofTransactionData({required dynamic transaction,}){

_transaction = ArgumentError.checkNotNull(transaction, 'ParamsOfProofTransactionData transaction');
}
ParamsOfProofTransactionData.fromMap(Map<String,dynamic> map){if (map.containsKey('transaction')&&(map['transaction']!=null)) {_transaction = map['transaction'];}else{throw('Wrong map data');}
}
...
ParamsOfProofMessageData({required dynamic message,}){

_message = ArgumentError.checkNotNull(message, 'ParamsOfProofMessageData message');
}
ParamsOfProofMessageData.fromMap(Map<String,dynamic> map){if (map.containsKey('message')&&(map['message']!=null)) {_message = map['message'];}else{throw('Wrong map data');}
}
