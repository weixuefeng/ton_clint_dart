...
Future<ResultOfGetAddressType> get_address_type(ParamsOfGetAddressType params) async {
final res = await _tonCore.request('utils.get_address_type',params.toString());
