...
Future<RegisteredDebot> init(ParamsOfInit params, Function? responseHandler) async {
final res = await _tonCore.request('debot.init',params.toString(),responseHandler);
