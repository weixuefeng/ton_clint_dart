...
NetErrorCode.WrongWebscoketProtocolSequence(){
_value = 'WrongWebscoketProtocolSequence';}
@override String toString() {return '"$_value"';}
NetErrorCode.fromMap(str) {_value = str;}
}
...
ParamsOfQueryOperation_QueryCollection({required String collection,dynamic? filter,required String result,List<OrderBy>? order,int? limit,}){

_type = 'QueryCollection';
_collection = ArgumentError.checkNotNull(collection, 'ParamsOfQueryOperation_QueryCollection collection');
_filter = filter;
_result = ArgumentError.checkNotNull(result, 'ParamsOfQueryOperation_QueryCollection result');
_order = order;
_limit = limit;
}
ParamsOfQueryOperation_QueryCollection.fromMap(Map<String,dynamic> map){if (!map.containsKey('type') || map['type']!= 'QueryCollection'){throw('Wrong map data');}else{_type = 'QueryCollection';}
if (map.containsKey('collection')&&(map['collection']!=null)) {_collection = map['collection'];}else{throw('Wrong map data');}
...
if (el != null) {_order?.add(OrderBy.fromMap(el));}else {}}}
...
ParamsOfQueryOperation_WaitForCollection({required String collection,dynamic? filter,required String result,int? timeout,}){

_type = 'WaitForCollection';
_collection = ArgumentError.checkNotNull(collection, 'ParamsOfQueryOperation_WaitForCollection collection');
_filter = filter;
_result = ArgumentError.checkNotNull(result, 'ParamsOfQueryOperation_WaitForCollection result');
_timeout = timeout;
}
ParamsOfQueryOperation_WaitForCollection.fromMap(Map<String,dynamic> map){if (!map.containsKey('type') || map['type']!= 'WaitForCollection'){throw('Wrong map data');}else{_type = 'WaitForCollection';}
if (map.containsKey('collection')&&(map['collection']!=null)) {_collection = map['collection'];}else{throw('Wrong map data');}
if (map.containsKey('filter')&&(map['filter']!=null)) {_filter = map['filter'];}
if (map.containsKey('result')&&(map['result']!=null)) {_result = map['result'];}else{throw('Wrong map data');}
...
class ParamsOfQueryOperation_AggregateCollection extends ParamsOfQueryOperation{
late String? _type;
String? get type => _type;
///Collection name (accounts, blocks, transactions, messages, block_signatures)
late String? _collection;
...
ParamsOfQueryOperation_AggregateCollection({required String collection,dynamic? filter,List<FieldAggregation>? fields,}){

_type = 'AggregateCollection';
_collection = ArgumentError.checkNotNull(collection, 'ParamsOfQueryOperation_AggregateCollection collection');
_filter = filter;
_fields = fields;
}
ParamsOfQueryOperation_AggregateCollection.fromMap(Map<String,dynamic> map){if (!map.containsKey('type') || map['type']!= 'AggregateCollection'){throw('Wrong map data');}else{_type = 'AggregateCollection';}
if (map.containsKey('collection')&&(map['collection']!=null)) {_collection = map['collection'];}else{throw('Wrong map data');}
if (map.containsKey('filter')&&(map['filter']!=null)) {_filter = map['filter'];}
if (map.containsKey('fields')&&(map['fields']!=null)) {_fields = [];
for (var el in map['fields']) {
if (el != null) {_fields?.add(FieldAggregation.fromMap(el));}else {}}}
}
...
class ParamsOfQueryOperation_QueryCounterparties extends ParamsOfQueryOperation{
late String? _type;
String? get type => _type;
///Account address
...
ParamsOfQueryOperation_QueryCounterparties({required String account,required String result,int? first,String? after,}){

_type = 'QueryCounterparties';
_account = ArgumentError.checkNotNull(account, 'ParamsOfQueryOperation_QueryCounterparties account');
_result = ArgumentError.checkNotNull(result, 'ParamsOfQueryOperation_QueryCounterparties result');
_first = first;
_after = after;
}
ParamsOfQueryOperation_QueryCounterparties.fromMap(Map<String,dynamic> map){if (!map.containsKey('type') || map['type']!= 'QueryCounterparties'){throw('Wrong map data');}else{_type = 'QueryCounterparties';}
if (map.containsKey('account')&&(map['account']!=null)) {_account = map['account'];}else{throw('Wrong map data');}
if (map.containsKey('result')&&(map['result']!=null)) {_result = map['result'];}else{throw('Wrong map data');}
if (map.containsKey('first')&&(map['first']!=null)) {_first = map['first'];}
if (map.containsKey('after')&&(map['after']!=null)) {_after = map['after'];}
}
...
if (_result!=null) {map['result'] = _result;}
if (_first!=null) {map['first'] = _first;}
if (_after!=null) {map['after'] = _after;}
map['type'] = _type;return map;
}
}
...
FieldAggregation({required String field,required AggregationFn fn,}){

_field = ArgumentError.checkNotNull(field, 'FieldAggregation field');
_fn = ArgumentError.checkNotNull(fn, 'FieldAggregation fn');
}
FieldAggregation.fromMap(Map<String,dynamic> map){if (map.containsKey('field')&&(map['field']!=null)) {_field = map['field'];}else{throw('Wrong map data');}
if (map.containsKey('fn')&&(map['fn']!=null)) {_fn = AggregationFn.fromMap(map['fn']);}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_field!=null) {map['field'] = _field;}
if (_fn!=null) {map['fn'] = _fn;}
return map;
}
}
...
_value = 'AVERAGE';}
@override String toString() {return '"$_value"';}
AggregationFn.fromMap(str) {_value = str;}
}
...
TransactionNode({required String id,required String in_msg,required List<String> out_msgs,required String account_addr,required String total_fees,required bool aborted,int? exit_code,}){

_id = ArgumentError.checkNotNull(id, 'TransactionNode id');
_in_msg = ArgumentError.checkNotNull(in_msg, 'TransactionNode in_msg');
_out_msgs = ArgumentError.checkNotNull(out_msgs, 'TransactionNode out_msgs');
_account_addr = ArgumentError.checkNotNull(account_addr, 'TransactionNode account_addr');
_total_fees = ArgumentError.checkNotNull(total_fees, 'TransactionNode total_fees');
_aborted = ArgumentError.checkNotNull(aborted, 'TransactionNode aborted');
_exit_code = exit_code;
}
TransactionNode.fromMap(Map<String,dynamic> map){if (map.containsKey('id')&&(map['id']!=null)) {_id = map['id'];}else{throw('Wrong map data');}
if (map.containsKey('in_msg')&&(map['in_msg']!=null)) {_in_msg = map['in_msg'];}else{throw('Wrong map data');}
if (map.containsKey('out_msgs')&&(map['out_msgs']!=null)) {_out_msgs = [];
for (var el in map['out_msgs']) {
if (el != null) {_out_msgs?.add(el);}else {}}}else{throw('Wrong map data');}
if (map.containsKey('account_addr')&&(map['account_addr']!=null)) {_account_addr = map['account_addr'];}else{throw('Wrong map data');}
if (map.containsKey('total_fees')&&(map['total_fees']!=null)) {_total_fees = map['total_fees'];}else{throw('Wrong map data');}
if (map.containsKey('aborted')&&(map['aborted']!=null)) {_aborted = map['aborted'];}else{throw('Wrong map data');}
if (map.containsKey('exit_code')&&(map['exit_code']!=null)) {_exit_code = map['exit_code'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_id!=null) {map['id'] = _id;}
if (_in_msg!=null) {map['in_msg'] = _in_msg;}
if (_out_msgs!=null) {map['out_msgs'] = _out_msgs;}
if (_account_addr!=null) {map['account_addr'] = _account_addr;}
if (_total_fees!=null) {map['total_fees'] = _total_fees;}
...
MessageNode({required String id,String? src_transaction_id,String? dst_transaction_id,String? src,String? dst,String? value,required bool bounce,DecodedMessageBody? decoded_body,}){
...
MessageNode.fromMap(Map<String,dynamic> map){if (map.containsKey('id')&&(map['id']!=null)) {_id = map['id'];}else{throw('Wrong map data');}
if (map.containsKey('src_transaction_id')&&(map['src_transaction_id']!=null)) {_src_transaction_id = map['src_transaction_id'];}
if (map.containsKey('dst_transaction_id')&&(map['dst_transaction_id']!=null)) {_dst_transaction_id = map['dst_transaction_id'];}
if (map.containsKey('src')&&(map['src']!=null)) {_src = map['src'];}
if (map.containsKey('dst')&&(map['dst']!=null)) {_dst = map['dst'];}
...
if (map.containsKey('decoded_body')&&(map['decoded_body']!=null)) {_decoded_body = DecodedMessageBody.fromMap(map['decoded_body']);}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_id!=null) {map['id'] = _id;}
if (_src_transaction_id!=null) {map['src_transaction_id'] = _src_transaction_id;}
if (_dst_transaction_id!=null) {map['dst_transaction_id'] = _dst_transaction_id;}
if (_src!=null) {map['src'] = _src;}
if (_dst!=null) {map['dst'] = _dst;}
if (_value!=null) {map['value'] = _value;}
if (_bounce!=null) {map['bounce'] = _bounce;}
if (_decoded_body!=null) {map['decoded_body'] = _decoded_body;}
return map;
}
}
...
ParamsOfQuery.fromMap(Map<String,dynamic> map){if (map.containsKey('query')&&(map['query']!=null)) {_query = map['query'];}else{throw('Wrong map data');}
if (map.containsKey('variables')&&(map['variables']!=null)) {_variables = map['variables'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_query!=null) {map['query'] = _query;}
if (_variables!=null) {map['variables'] = _variables;}
return map;
}
}
...
ResultOfQuery({required dynamic result,}){

_result = ArgumentError.checkNotNull(result, 'ResultOfQuery result');
}
ResultOfQuery.fromMap(Map<String,dynamic> map){if (map.containsKey('result')&&(map['result']!=null)) {_result = map['result'];}else{throw('Wrong map data');}
}
...
ParamsOfBatchQuery({required List<ParamsOfQueryOperation> operations,}){

_operations = ArgumentError.checkNotNull(operations, 'ParamsOfBatchQuery operations');
}
ParamsOfBatchQuery.fromMap(Map<String,dynamic> map){if (map.containsKey('operations')&&(map['operations']!=null)) {_operations = [];
for (var el in map['operations']) {
if (el != null) {_operations?.add(ParamsOfQueryOperation.fromMap(el));}else {}}}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_operations!=null) {map['operations'] = _operations;}
return map;
}
}
...
ResultOfBatchQuery({required List<dynamic> results,}){

_results = ArgumentError.checkNotNull(results, 'ResultOfBatchQuery results');
}
ResultOfBatchQuery.fromMap(Map<String,dynamic> map){if (map.containsKey('results')&&(map['results']!=null)) {_results = [];
for (var el in map['results']) {
if (el != null) {_results?.add(el);}else {}}}else{throw('Wrong map data');}
}
...
if (el != null) {_result?.add(el);}else {}}}else{throw('Wrong map data');}
}
...
late List<FieldAggregation>? _fields;
List<FieldAggregation>? get fields => _fields;
ParamsOfAggregateCollection({required String collection,dynamic? filter,List<FieldAggregation>? fields,}){

_collection = ArgumentError.checkNotNull(collection, 'ParamsOfAggregateCollection collection');
_filter = filter;
_fields = fields;
}
ParamsOfAggregateCollection.fromMap(Map<String,dynamic> map){if (map.containsKey('collection')&&(map['collection']!=null)) {_collection = map['collection'];}else{throw('Wrong map data');}
if (map.containsKey('filter')&&(map['filter']!=null)) {_filter = map['filter'];}
if (map.containsKey('fields')&&(map['fields']!=null)) {_fields = [];
for (var el in map['fields']) {
if (el != null) {_fields?.add(FieldAggregation.fromMap(el));}else {}}}
...
ResultOfAggregateCollection({required dynamic values,}){

_values = ArgumentError.checkNotNull(values, 'ResultOfAggregateCollection values');
}
ResultOfAggregateCollection.fromMap(Map<String,dynamic> map){if (map.containsKey('values')&&(map['values']!=null)) {_values = map['values'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_values!=null) {map['values'] = _values;}
return map;
}
}
...
late dynamic? _variables;
dynamic? get variables => _variables;
ParamsOfSubscribe({required String subscription,dynamic? variables,}){

_subscription = ArgumentError.checkNotNull(subscription, 'ParamsOfSubscribe subscription');
_variables = variables;
}
ParamsOfSubscribe.fromMap(Map<String,dynamic> map){if (map.containsKey('subscription')&&(map['subscription']!=null)) {_subscription = map['subscription'];}else{throw('Wrong map data');}
if (map.containsKey('variables')&&(map['variables']!=null)) {_variables = map['variables'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_subscription!=null) {map['subscription'] = _subscription;}
if (_variables!=null) {map['variables'] = _variables;}
return map;
}
}
...
ParamsOfFindLastShardBlock({required String address,}){

_address = ArgumentError.checkNotNull(address, 'ParamsOfFindLastShardBlock address');
}
ParamsOfFindLastShardBlock.fromMap(Map<String,dynamic> map){if (map.containsKey('address')&&(map['address']!=null)) {_address = map['address'];}else{throw('Wrong map data');}
}
...
ResultOfFindLastShardBlock({required String block_id,}){

_block_id = ArgumentError.checkNotNull(block_id, 'ResultOfFindLastShardBlock block_id');
}
ResultOfFindLastShardBlock.fromMap(Map<String,dynamic> map){if (map.containsKey('block_id')&&(map['block_id']!=null)) {_block_id = map['block_id'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_block_id!=null) {map['block_id'] = _block_id;}
return map;
}
}
...
EndpointsSet({required List<String> endpoints,}){

_endpoints = ArgumentError.checkNotNull(endpoints, 'EndpointsSet endpoints');
}
EndpointsSet.fromMap(Map<String,dynamic> map){if (map.containsKey('endpoints')&&(map['endpoints']!=null)) {_endpoints = [];
for (var el in map['endpoints']) {
if (el != null) {_endpoints?.add(el);}else {}}}else{throw('Wrong map data');}
}
...
late List<String>? _endpoints;
List<String>? get endpoints => _endpoints;
ResultOfGetEndpoints({required String query,required List<String> endpoints,}){

_query = ArgumentError.checkNotNull(query, 'ResultOfGetEndpoints query');
_endpoints = ArgumentError.checkNotNull(endpoints, 'ResultOfGetEndpoints endpoints');
}
ResultOfGetEndpoints.fromMap(Map<String,dynamic> map){if (map.containsKey('query')&&(map['query']!=null)) {_query = map['query'];}else{throw('Wrong map data');}
if (map.containsKey('endpoints')&&(map['endpoints']!=null)) {_endpoints = [];
for (var el in map['endpoints']) {
if (el != null) {_endpoints?.add(el);}else {}}}else{throw('Wrong map data');}
}
...
late String? _after;
String? get after => _after;
ParamsOfQueryCounterparties({required String account,required String result,int? first,String? after,}){

_account = ArgumentError.checkNotNull(account, 'ParamsOfQueryCounterparties account');
_result = ArgumentError.checkNotNull(result, 'ParamsOfQueryCounterparties result');
_first = first;
_after = after;
}
ParamsOfQueryCounterparties.fromMap(Map<String,dynamic> map){if (map.containsKey('account')&&(map['account']!=null)) {_account = map['account'];}else{throw('Wrong map data');}
if (map.containsKey('result')&&(map['result']!=null)) {_result = map['result'];}else{throw('Wrong map data');}
if (map.containsKey('first')&&(map['first']!=null)) {_first = map['first'];}
if (map.containsKey('after')&&(map['after']!=null)) {_after = map['after'];}
}
...
ParamsOfQueryTransactionTree({required String in_msg,List<Abi>? abi_registry,int? timeout,int? transaction_max_count,}){

_in_msg = ArgumentError.checkNotNull(in_msg, 'ParamsOfQueryTransactionTree in_msg');
_abi_registry = abi_registry;
_timeout = timeout;
_transaction_max_count = transaction_max_count;
}
ParamsOfQueryTransactionTree.fromMap(Map<String,dynamic> map){if (map.containsKey('in_msg')&&(map['in_msg']!=null)) {_in_msg = map['in_msg'];}else{throw('Wrong map data');}
if (map.containsKey('abi_registry')&&(map['abi_registry']!=null)) {_abi_registry = [];
for (var el in map['abi_registry']) {
if (el != null) {_abi_registry?.add(Abi.fromMap(el));}else {}}}
if (map.containsKey('timeout')&&(map['timeout']!=null)) {_timeout = map['timeout'];}
if (map.containsKey('transaction_max_count')&&(map['transaction_max_count']!=null)) {_transaction_max_count = map['transaction_max_count'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_in_msg!=null) {map['in_msg'] = _in_msg;}
if (_abi_registry!=null) {map['abi_registry'] = _abi_registry;}
if (_timeout!=null) {map['timeout'] = _timeout;}
if (_transaction_max_count!=null) {map['transaction_max_count'] = _transaction_max_count;}
return map;
}
}
...
ResultOfQueryTransactionTree({required List<MessageNode> messages,required List<TransactionNode> transactions,}){

_messages = ArgumentError.checkNotNull(messages, 'ResultOfQueryTransactionTree messages');
_transactions = ArgumentError.checkNotNull(transactions, 'ResultOfQueryTransactionTree transactions');
}
ResultOfQueryTransactionTree.fromMap(Map<String,dynamic> map){if (map.containsKey('messages')&&(map['messages']!=null)) {_messages = [];
for (var el in map['messages']) {
if (el != null) {_messages?.add(MessageNode.fromMap(el));}else {}}}else{throw('Wrong map data');}
if (map.containsKey('transactions')&&(map['transactions']!=null)) {_transactions = [];
for (var el in map['transactions']) {
if (el != null) {_transactions?.add(TransactionNode.fromMap(el));}else {}}}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_messages!=null) {map['messages'] = _messages;}
if (_transactions!=null) {map['transactions'] = _transactions;}
return map;
}
}
...
late String? _result;
String? get result => _result;
ParamsOfCreateBlockIterator({int? start_time,int? end_time,List<String>? shard_filter,String? result,}){
...
ParamsOfCreateBlockIterator.fromMap(Map<String,dynamic> map){if (map.containsKey('start_time')&&(map['start_time']!=null)) {_start_time = map['start_time'];}
if (map.containsKey('end_time')&&(map['end_time']!=null)) {_end_time = map['end_time'];}
if (map.containsKey('shard_filter')&&(map['shard_filter']!=null)) {_shard_filter = [];
for (var el in map['shard_filter']) {
if (el != null) {_shard_filter?.add(el);}else {}}}
if (map.containsKey('result')&&(map['result']!=null)) {_result = map['result'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_start_time!=null) {map['start_time'] = _start_time;}
if (_end_time!=null) {map['end_time'] = _end_time;}
if (_shard_filter!=null) {map['shard_filter'] = _shard_filter;}
if (_result!=null) {map['result'] = _result;}
return map;
}
}
...
late int? _handle;
int? get handle => _handle;
RegisteredIterator({required int handle,}){

_handle = ArgumentError.checkNotNull(handle, 'RegisteredIterator handle');
}
RegisteredIterator.fromMap(Map<String,dynamic> map){if (map.containsKey('handle')&&(map['handle']!=null)) {_handle = map['handle'];}else{throw('Wrong map data');}
}
...
ParamsOfResumeBlockIterator({required dynamic resume_state,}){

_resume_state = ArgumentError.checkNotNull(resume_state, 'ParamsOfResumeBlockIterator resume_state');
}
ParamsOfResumeBlockIterator.fromMap(Map<String,dynamic> map){if (map.containsKey('resume_state')&&(map['resume_state']!=null)) {_resume_state = map['resume_state'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_resume_state!=null) {map['resume_state'] = _resume_state;}
return map;
}
}
...
ParamsOfCreateTransactionIterator({int? start_time,int? end_time,List<String>? shard_filter,List<String>? accounts_filter,String? result,bool? include_transfers,}){
...
ParamsOfCreateTransactionIterator.fromMap(Map<String,dynamic> map){if (map.containsKey('start_time')&&(map['start_time']!=null)) {_start_time = map['start_time'];}
if (map.containsKey('end_time')&&(map['end_time']!=null)) {_end_time = map['end_time'];}
if (map.containsKey('shard_filter')&&(map['shard_filter']!=null)) {_shard_filter = [];
for (var el in map['shard_filter']) {
if (el != null) {_shard_filter?.add(el);}else {}}}
if (map.containsKey('accounts_filter')&&(map['accounts_filter']!=null)) {_accounts_filter = [];
for (var el in map['accounts_filter']) {
if (el != null) {_accounts_filter?.add(el);}else {}}}
if (map.containsKey('result')&&(map['result']!=null)) {_result = map['result'];}
if (map.containsKey('include_transfers')&&(map['include_transfers']!=null)) {_include_transfers = map['include_transfers'];}
}
...
if (_end_time!=null) {map['end_time'] = _end_time;}
if (_shard_filter!=null) {map['shard_filter'] = _shard_filter;}
if (_accounts_filter!=null) {map['accounts_filter'] = _accounts_filter;}
if (_result!=null) {map['result'] = _result;}
if (_include_transfers!=null) {map['include_transfers'] = _include_transfers;}
return map;
}
}
...
late List<String>? _accounts_filter;
List<String>? get accounts_filter => _accounts_filter;
ParamsOfResumeTransactionIterator({required dynamic resume_state,List<String>? accounts_filter,}){

_resume_state = ArgumentError.checkNotNull(resume_state, 'ParamsOfResumeTransactionIterator resume_state');
_accounts_filter = accounts_filter;
}
ParamsOfResumeTransactionIterator.fromMap(Map<String,dynamic> map){if (map.containsKey('resume_state')&&(map['resume_state']!=null)) {_resume_state = map['resume_state'];}else{throw('Wrong map data');}
if (map.containsKey('accounts_filter')&&(map['accounts_filter']!=null)) {_accounts_filter = [];
for (var el in map['accounts_filter']) {
if (el != null) {_accounts_filter?.add(el);}else {}}}
}
...
ParamsOfIteratorNext({required int iterator,int? limit,bool? return_resume_state,}){

_iterator = ArgumentError.checkNotNull(iterator, 'ParamsOfIteratorNext iterator');
_limit = limit;
_return_resume_state = return_resume_state;
}
ParamsOfIteratorNext.fromMap(Map<String,dynamic> map){if (map.containsKey('iterator')&&(map['iterator']!=null)) {_iterator = map['iterator'];}else{throw('Wrong map data');}
if (map.containsKey('limit')&&(map['limit']!=null)) {_limit = map['limit'];}
if (map.containsKey('return_resume_state')&&(map['return_resume_state']!=null)) {_return_resume_state = map['return_resume_state'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_iterator!=null) {map['iterator'] = _iterator;}
if (_limit!=null) {map['limit'] = _limit;}
if (_return_resume_state!=null) {map['return_resume_state'] = _return_resume_state;}
return map;
}
}
...
late dynamic? _resume_state;
dynamic? get resume_state => _resume_state;
ResultOfIteratorNext({required List<dynamic> items,required bool has_more,dynamic? resume_state,}){

_items = ArgumentError.checkNotNull(items, 'ResultOfIteratorNext items');
_has_more = ArgumentError.checkNotNull(has_more, 'ResultOfIteratorNext has_more');
_resume_state = resume_state;
}
ResultOfIteratorNext.fromMap(Map<String,dynamic> map){if (map.containsKey('items')&&(map['items']!=null)) {_items = [];
for (var el in map['items']) {
if (el != null) {_items?.add(el);}else {}}}else{throw('Wrong map data');}
if (map.containsKey('has_more')&&(map['has_more']!=null)) {_has_more = map['has_more'];}else{throw('Wrong map data');}
if (map.containsKey('resume_state')&&(map['resume_state']!=null)) {_resume_state = map['resume_state'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_items!=null) {map['items'] = _items;}
if (_has_more!=null) {map['has_more'] = _has_more;}
if (_resume_state!=null) {map['resume_state'] = _resume_state;}
return map;
}
}
...
ResultOfGetSignatureId({int? signature_id,}){

_signature_id = signature_id;
}
ResultOfGetSignatureId.fromMap(Map<String,dynamic> map){if (map.containsKey('signature_id')&&(map['signature_id']!=null)) {_signature_id = map['signature_id'];}
}
