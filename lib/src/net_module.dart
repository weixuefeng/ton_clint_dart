...
Future<ResultOfQueryCollection> query_collection(ParamsOfQueryCollection params) async {
final res = await _tonCore.request('net.query_collection',params.toString());
 return ResultOfQueryCollection.fromMap(res);}
///Aggregates values from the specified `fields` for records
///that satisfies the `filter` conditions,
Future<ResultOfAggregateCollection> aggregate_collection(ParamsOfAggregateCollection params) async {
final res = await _tonCore.request('net.aggregate_collection',params.toString());
...
///and returns it.
///The projection fields are limited to `result` fields
Future<ResultOfWaitForCollection> wait_for_collection(ParamsOfWaitForCollection params) async {
final res = await _tonCore.request('net.wait_for_collection',params.toString());
...
Future<ResultOfSubscribeCollection> subscribe_collection(ParamsOfSubscribeCollection params, Function? responseHandler) async {
final res = await _tonCore.request('net.subscribe_collection',params.toString(),responseHandler);
...
///(for example transactions of the specific account): application must
///refresh all cached (or visible to user) lists where this sequences presents.
Future<ResultOfSubscribeCollection> subscribe(ParamsOfSubscribe params, Function? responseHandler) async {
final res = await _tonCore.request('net.subscribe',params.toString(),responseHandler);
 return ResultOfSubscribeCollection.fromMap(res);}
...
Future<ResultOfFindLastShardBlock> find_last_shard_block(ParamsOfFindLastShardBlock params) async {
final res = await _tonCore.request('net.find_last_shard_block',params.toString());
...
Future<ResultOfQueryCollection> query_counterparties(ParamsOfQueryCounterparties params) async {
final res = await _tonCore.request('net.query_counterparties',params.toString());
 return ResultOfQueryCollection.fromMap(res);}
...
Future<ResultOfQueryTransactionTree> query_transaction_tree(ParamsOfQueryTransactionTree params) async {
final res = await _tonCore.request('net.query_transaction_tree',params.toString());
...
Future<RegisteredIterator> create_block_iterator(ParamsOfCreateBlockIterator params) async {
final res = await _tonCore.request('net.create_block_iterator',params.toString());
 return RegisteredIterator.fromMap(res);}
///The iterator stays exactly at the same position where the `resume_state` was caught.
///
///Application should call the `remove_iterator` when iterator is no longer required.
Future<RegisteredIterator> resume_block_iterator(ParamsOfResumeBlockIterator params) async {
final res = await _tonCore.request('net.resume_block_iterator',params.toString());
 return RegisteredIterator.fromMap(res);}
...
///
///Application should call the `remove_iterator` when iterator is no longer required.
Future<RegisteredIterator> create_transaction_iterator(ParamsOfCreateTransactionIterator params) async {
final res = await _tonCore.request('net.create_transaction_iterator',params.toString());
 return RegisteredIterator.fromMap(res);}
///The iterator stays exactly at the same position where the `resume_state` was caught.
...
///
///Application should call the `remove_iterator` when iterator is no longer required.
Future<RegisteredIterator> resume_transaction_iterator(ParamsOfResumeTransactionIterator params) async {
final res = await _tonCore.request('net.resume_transaction_iterator',params.toString());
 return RegisteredIterator.fromMap(res);}
...
Future<ResultOfIteratorNext> iterator_next(ParamsOfIteratorNext params) async {
...
Future<ResultOfGetSignatureId> get_signature_id() async {
final res = await _tonCore.request('net.get_signature_id');
 return ResultOfGetSignatureId.fromMap(res);}
}