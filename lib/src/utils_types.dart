...
AccountAddressType.fromMap(str) {_value = str;}
}
...
late String? _address;
String? get address => _address;
ParamsOfGetAddressType({required String address,}){

_address = ArgumentError.checkNotNull(address, 'ParamsOfGetAddressType address');
}
ParamsOfGetAddressType.fromMap(Map<String,dynamic> map){if (map.containsKey('address')&&(map['address']!=null)) {_address = map['address'];}else{throw('Wrong map data');}
}
...
ResultOfGetAddressType({required AccountAddressType address_type,}){

_address_type = ArgumentError.checkNotNull(address_type, 'ResultOfGetAddressType address_type');
}
ResultOfGetAddressType.fromMap(Map<String,dynamic> map){if (map.containsKey('address_type')&&(map['address_type']!=null)) {_address_type = AccountAddressType.fromMap(map['address_type']);}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_address_type!=null) {map['address_type'] = _address_type;}
return map;
}
}
...
ParamsOfCalcStorageFee({required String account,required int period,}){

_account = ArgumentError.checkNotNull(account, 'ParamsOfCalcStorageFee account');
_period = ArgumentError.checkNotNull(period, 'ParamsOfCalcStorageFee period');
}
ParamsOfCalcStorageFee.fromMap(Map<String,dynamic> map){if (map.containsKey('account')&&(map['account']!=null)) {_account = map['account'];}else{throw('Wrong map data');}
if (map.containsKey('period')&&(map['period']!=null)) {_period = map['period'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_account!=null) {map['account'] = _account;}
if (_period!=null) {map['period'] = _period;}
return map;
}
}
...
late String? _fee;
String? get fee => _fee;
ResultOfCalcStorageFee({required String fee,}){

_fee = ArgumentError.checkNotNull(fee, 'ResultOfCalcStorageFee fee');
}
ResultOfCalcStorageFee.fromMap(Map<String,dynamic> map){if (map.containsKey('fee')&&(map['fee']!=null)) {_fee = map['fee'];}else{throw('Wrong map data');}
}
...
ParamsOfCompressZstd({required String uncompressed,int? level,}){

_uncompressed = ArgumentError.checkNotNull(uncompressed, 'ParamsOfCompressZstd uncompressed');
_level = level;
}
ParamsOfCompressZstd.fromMap(Map<String,dynamic> map){if (map.containsKey('uncompressed')&&(map['uncompressed']!=null)) {_uncompressed = map['uncompressed'];}else{throw('Wrong map data');}
if (map.containsKey('level')&&(map['level']!=null)) {_level = map['level'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_uncompressed!=null) {map['uncompressed'] = _uncompressed;}
if (_level!=null) {map['level'] = _level;}
return map;
}
}
...
ResultOfCompressZstd({required String compressed,}){

_compressed = ArgumentError.checkNotNull(compressed, 'ResultOfCompressZstd compressed');
}
ResultOfCompressZstd.fromMap(Map<String,dynamic> map){if (map.containsKey('compressed')&&(map['compressed']!=null)) {_compressed = map['compressed'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_compressed!=null) {map['compressed'] = _compressed;}
return map;
}
}
...
late String? _compressed;
String? get compressed => _compressed;
ParamsOfDecompressZstd({required String compressed,}){

_compressed = ArgumentError.checkNotNull(compressed, 'ParamsOfDecompressZstd compressed');
}
ParamsOfDecompressZstd.fromMap(Map<String,dynamic> map){if (map.containsKey('compressed')&&(map['compressed']!=null)) {_compressed = map['compressed'];}else{throw('Wrong map data');}
}
...
ResultOfDecompressZstd({required String decompressed,}){

_decompressed = ArgumentError.checkNotNull(decompressed, 'ResultOfDecompressZstd decompressed');
}
ResultOfDecompressZstd.fromMap(Map<String,dynamic> map){if (map.containsKey('decompressed')&&(map['decompressed']!=null)) {_decompressed = map['decompressed'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_decompressed!=null) {map['decompressed'] = _decompressed;}
return map;
}
}
