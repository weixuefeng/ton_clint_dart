...
ClientErrorCode.fromMap(str) {_value = str;}
}
...
ClientError({required int code,required String message,required dynamic data,}){
...
ClientError.fromMap(Map<String,dynamic> map){if (map.containsKey('code')&&(map['code']!=null)) {_code = map['code'];}else{throw('Wrong map data');}
...
ClientConfig({BindingConfig? binding,NetworkConfig? network,CryptoConfig? crypto,AbiConfig? abi,BocConfig? boc,ProofsConfig? proofs,String? local_storage_path,}){
...
ClientConfig.fromMap(Map<String,dynamic> map){if (map.containsKey('binding')&&(map['binding']!=null)) {_binding = BindingConfig.fromMap(map['binding']);}
if (map.containsKey('network')&&(map['network']!=null)) {_network = NetworkConfig.fromMap(map['network']);}
...
if (map.containsKey('proofs')&&(map['proofs']!=null)) {_proofs = ProofsConfig.fromMap(map['proofs']);}
if (map.containsKey('local_storage_path')&&(map['local_storage_path']!=null)) {_local_storage_path = map['local_storage_path'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_binding!=null) {map['binding'] = _binding;}
...
if (_proofs!=null) {map['proofs'] = _proofs;}
if (_local_storage_path!=null) {map['local_storage_path'] = _local_storage_path;}
return map;
}
}
...
NetworkConfig({String? server_address,List<String>? endpoints,int? network_retries_count,int? max_reconnect_timeout,int? reconnect_timeout,int? message_retries_count,int? message_processing_timeout,int? wait_for_timeout,int? out_of_sync_threshold,int? sending_endpoint_count,int? latency_detection_interval,int? max_latency,int? query_timeout,NetworkQueriesProtocol? queries_protocol,int? first_remp_status_timeout,int? next_remp_status_timeout,int? signature_id,String? access_key,}){
...
if (el != null) {_endpoints?.add(el);}else {}}}
...
if (map.containsKey('query_timeout')&&(map['query_timeout']!=null)) {_query_timeout = map['query_timeout'];}
if (map.containsKey('queries_protocol')&&(map['queries_protocol']!=null)) {_queries_protocol = NetworkQueriesProtocol.fromMap(map['queries_protocol']);}
if (map.containsKey('first_remp_status_timeout')&&(map['first_remp_status_timeout']!=null)) {_first_remp_status_timeout = map['first_remp_status_timeout'];}
if (map.containsKey('next_remp_status_timeout')&&(map['next_remp_status_timeout']!=null)) {_next_remp_status_timeout = map['next_remp_status_timeout'];}
...
if (_query_timeout!=null) {map['query_timeout'] = _query_timeout;}
if (_queries_protocol!=null) {map['queries_protocol'] = _queries_protocol;}
if (_first_remp_status_timeout!=null) {map['first_remp_status_timeout'] = _first_remp_status_timeout;}
if (_next_remp_status_timeout!=null) {map['next_remp_status_timeout'] = _next_remp_status_timeout;}
...
BindingConfig({String? library,String? version,}){

_library = library;
_version = version;
}
BindingConfig.fromMap(Map<String,dynamic> map){if (map.containsKey('library')&&(map['library']!=null)) {_library = map['library'];}
...
_value = 'WS';}
@override String toString() {return '"$_value"';}
NetworkQueriesProtocol.fromMap(str) {_value = str;}
}
///Crypto config.
...
CryptoConfig({MnemonicDictionary? mnemonic_dictionary,int? mnemonic_word_count,String? hdkey_derivation_path,}){
...
CryptoConfig.fromMap(Map<String,dynamic> map){if (map.containsKey('mnemonic_dictionary')&&(map['mnemonic_dictionary']!=null)) {_mnemonic_dictionary = MnemonicDictionary.fromMap(map['mnemonic_dictionary']);}
if (map.containsKey('mnemonic_word_count')&&(map['mnemonic_word_count']!=null)) {_mnemonic_word_count = map['mnemonic_word_count'];}
if (map.containsKey('hdkey_derivation_path')&&(map['hdkey_derivation_path']!=null)) {_hdkey_derivation_path = map['hdkey_derivation_path'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_mnemonic_dictionary!=null) {map['mnemonic_dictionary'] = _mnemonic_dictionary;}
if (_mnemonic_word_count!=null) {map['mnemonic_word_count'] = _mnemonic_word_count;}
if (_hdkey_derivation_path!=null) {map['hdkey_derivation_path'] = _hdkey_derivation_path;}
return map;
}
}
...
int? get message_expiration_timeout_grow_factor => _message_expiration_timeout_grow_factor;
AbiConfig({int? workchain,int? message_expiration_timeout,int? message_expiration_timeout_grow_factor,}){

_workchain = workchain;
_message_expiration_timeout = message_expiration_timeout;
_message_expiration_timeout_grow_factor = message_expiration_timeout_grow_factor;
}
AbiConfig.fromMap(Map<String,dynamic> map){if (map.containsKey('workchain')&&(map['workchain']!=null)) {_workchain = map['workchain'];}
if (map.containsKey('message_expiration_timeout')&&(map['message_expiration_timeout']!=null)) {_message_expiration_timeout = map['message_expiration_timeout'];}
if (map.containsKey('message_expiration_timeout_grow_factor')&&(map['message_expiration_timeout_grow_factor']!=null)) {_message_expiration_timeout_grow_factor = map['message_expiration_timeout_grow_factor'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_workchain!=null) {map['workchain'] = _workchain;}
if (_message_expiration_timeout!=null) {map['message_expiration_timeout'] = _message_expiration_timeout;}
if (_message_expiration_timeout_grow_factor!=null) {map['message_expiration_timeout_grow_factor'] = _message_expiration_timeout_grow_factor;}
return map;
}
}
...
ProofsConfig({bool? cache_in_local_storage,}){

_cache_in_local_storage = cache_in_local_storage;
}
ProofsConfig.fromMap(Map<String,dynamic> map){if (map.containsKey('cache_in_local_storage')&&(map['cache_in_local_storage']!=null)) {_cache_in_local_storage = map['cache_in_local_storage'];}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_cache_in_local_storage!=null) {map['cache_in_local_storage'] = _cache_in_local_storage;}
return map;
}
}
...
BuildInfoDependency({required String name,required String git_commit,}){

_name = ArgumentError.checkNotNull(name, 'BuildInfoDependency name');
_git_commit = ArgumentError.checkNotNull(git_commit, 'BuildInfoDependency git_commit');
}
BuildInfoDependency.fromMap(Map<String,dynamic> map){if (map.containsKey('name')&&(map['name']!=null)) {_name = map['name'];}else{throw('Wrong map data');}
if (map.containsKey('git_commit')&&(map['git_commit']!=null)) {_git_commit = map['git_commit'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_name!=null) {map['name'] = _name;}
if (_git_commit!=null) {map['git_commit'] = _git_commit;}
return map;
}
}
...
ParamsOfAppRequest({required int app_request_id,required dynamic request_data,}){

_app_request_id = ArgumentError.checkNotNull(app_request_id, 'ParamsOfAppRequest app_request_id');
_request_data = ArgumentError.checkNotNull(request_data, 'ParamsOfAppRequest request_data');
}
ParamsOfAppRequest.fromMap(Map<String,dynamic> map){if (map.containsKey('app_request_id')&&(map['app_request_id']!=null)) {_app_request_id = map['app_request_id'];}else{throw('Wrong map data');}
if (map.containsKey('request_data')&&(map['request_data']!=null)) {_request_data = map['request_data'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_app_request_id!=null) {map['app_request_id'] = _app_request_id;}
if (_request_data!=null) {map['request_data'] = _request_data;}
return map;
}
}
...
AppRequestResult_Error({required String text,}){

_type = 'Error';
_text = ArgumentError.checkNotNull(text, 'AppRequestResult_Error text');
}
AppRequestResult_Error.fromMap(Map<String,dynamic> map){if (!map.containsKey('type') || map['type']!= 'Error'){throw('Wrong map data');}else{_type = 'Error';}
if (map.containsKey('text')&&(map['text']!=null)) {_text = map['text'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_text!=null) {map['text'] = _text;}
...
AppRequestResult_Ok({required dynamic result,}){

_type = 'Ok';
_result = ArgumentError.checkNotNull(result, 'AppRequestResult_Ok result');
}
AppRequestResult_Ok.fromMap(Map<String,dynamic> map){if (!map.containsKey('type') || map['type']!= 'Ok'){throw('Wrong map data');}else{_type = 'Ok';}
...
ResultOfGetApiReference({required dynamic api,}){

_api = ArgumentError.checkNotNull(api, 'ResultOfGetApiReference api');
}
ResultOfGetApiReference.fromMap(Map<String,dynamic> map){if (map.containsKey('api')&&(map['api']!=null)) {_api = map['api'];}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_api!=null) {map['api'] = _api;}
return map;
}
}
...
late String? _version;
String? get version => _version;
ResultOfVersion({required String version,}){

_version = ArgumentError.checkNotNull(version, 'ResultOfVersion version');
}
ResultOfVersion.fromMap(Map<String,dynamic> map){if (map.containsKey('version')&&(map['version']!=null)) {_version = map['version'];}else{throw('Wrong map data');}
}
...
ResultOfBuildInfo({required int build_number,required List<BuildInfoDependency> dependencies,}){

_build_number = ArgumentError.checkNotNull(build_number, 'ResultOfBuildInfo build_number');
_dependencies = ArgumentError.checkNotNull(dependencies, 'ResultOfBuildInfo dependencies');
}
ResultOfBuildInfo.fromMap(Map<String,dynamic> map){if (map.containsKey('build_number')&&(map['build_number']!=null)) {_build_number = map['build_number'];}else{throw('Wrong map data');}
if (map.containsKey('dependencies')&&(map['dependencies']!=null)) {_dependencies = [];
for (var el in map['dependencies']) {
if (el != null) {_dependencies?.add(BuildInfoDependency.fromMap(el));}else {}}}else{throw('Wrong map data');}
}

Map<String,dynamic> toMap(){
Map<String,dynamic> map ={};
if (_build_number!=null) {map['build_number'] = _build_number;}
if (_dependencies!=null) {map['dependencies'] = _dependencies;}
return map;
}
}
...
ParamsOfResolveAppRequest({required int app_request_id,required AppRequestResult result,}){

_app_request_id = ArgumentError.checkNotNull(app_request_id, 'ParamsOfResolveAppRequest app_request_id');
_result = ArgumentError.checkNotNull(result, 'ParamsOfResolveAppRequest result');
}
ParamsOfResolveAppRequest.fromMap(Map<String,dynamic> map){if (map.containsKey('app_request_id')&&(map['app_request_id']!=null)) {_app_request_id = map['app_request_id'];}else{throw('Wrong map data');}
if (map.containsKey('result')&&(map['result']!=null)) {_result = AppRequestResult.fromMap(map['result']);}else{throw('Wrong map data');}
}
