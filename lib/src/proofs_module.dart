...
class ProofsModule extends _TonSdkModule {
  ProofsModule(TonSdkCore core) : super(core);
...
Future<void> proof_block_data(ParamsOfProofBlockData params) async {
await _tonCore.request('proofs.proof_block_data',params.toString());}
...
Future<void> proof_transaction_data(ParamsOfProofTransactionData params) async {
await _tonCore.request('proofs.proof_transaction_data',params.toString());}
...
///
///For more information about proofs checking, see description of `proof_block_data` function.
Future<void> proof_message_data(ParamsOfProofMessageData params) async {
await _tonCore.request('proofs.proof_message_data',params.toString());}
}