...
Future<ResultOfEncodeInitialData> encode_initial_data(ParamsOfEncodeInitialData params) async {
final res = await _tonCore.request('abi.encode_initial_data',params.toString());
...
Future<ResultOfCalcFunctionId> calc_function_id(ParamsOfCalcFunctionId params) async {
final res = await _tonCore.request('abi.calc_function_id',params.toString());
...
Future<ResultOfGetSignatureData> get_signature_data(ParamsOfGetSignatureData params) async {
final res = await _tonCore.request('abi.get_signature_data',params.toString());
