...
if (el != null) {_builder?.add(BuilderOp.fromMap(el));}else {}}}else{throw('Wrong map data');}
}
...
BuilderOp_Address({required String address,}){

_type = 'Address';
_address = ArgumentError.checkNotNull(address, 'BuilderOp_Address address');
}
BuilderOp_Address.fromMap(Map<String,dynamic> map){if (!map.containsKey('type') || map['type']!= 'Address'){throw('Wrong map data');}else{_type = 'Address';}
...
abstract class Tvc extends TonSdkStructure{
static Tvc fromMap(Map<String,dynamic> map){
if (map['type']=='V1'){
return Tvc_V1.fromMap(map);
}
throw('Tvc unknown from map type');
}
}
...
Tvc_V1({required TvcV1 value,}){

_type = 'V1';
_value = ArgumentError.checkNotNull(value, 'Tvc_V1 value');
}
Tvc_V1.fromMap(Map<String,dynamic> map){if (!map.containsKey('type') || map['type']!= 'V1'){throw('Wrong map data');}else{_type = 'V1';}
if (map.containsKey('value')&&(map['value']!=null)) {_value = TvcV1.fromMap(map['value']);}else{throw('Wrong map data');}
}
...
TvcV1({String? code,String? description,}){

_code = code;
_description = description;
}
TvcV1.fromMap(Map<String,dynamic> map){if (map.containsKey('code')&&(map['code']!=null)) {_code = map['code'];}
if (map.containsKey('description')&&(map['description']!=null)) {_description = map['description'];}
}
...
late String? _tvc;
String? get tvc => _tvc;
ParamsOfDecodeTvc({required String tvc,}){
...
late Tvc? _tvc;
Tvc? get tvc => _tvc;
ResultOfDecodeTvc({required Tvc tvc,}){

_tvc = ArgumentError.checkNotNull(tvc, 'ResultOfDecodeTvc tvc');
}
ResultOfDecodeTvc.fromMap(Map<String,dynamic> map){if (map.containsKey('tvc')&&(map['tvc']!=null)) {_tvc = Tvc.fromMap(map['tvc']);}else{throw('Wrong map data');}
}
...
late BocCacheType? _boc_cache;
BocCacheType? get boc_cache => _boc_cache;
ParamsOfDecodeStateInit({required String state_init,BocCacheType? boc_cache,}){

_state_init = ArgumentError.checkNotNull(state_init, 'ParamsOfDecodeStateInit state_init');
_boc_cache = boc_cache;
}
ParamsOfDecodeStateInit.fromMap(Map<String,dynamic> map){if (map.containsKey('state_init')&&(map['state_init']!=null)) {_state_init = map['state_init'];}else{throw('Wrong map data');}
if (map.containsKey('boc_cache')&&(map['boc_cache']!=null)) {_boc_cache = BocCacheType.fromMap(map['boc_cache']);}
}
...
ResultOfDecodeStateInit({String? code,String? code_hash,int? code_depth,String? data,String? data_hash,int? data_depth,String? library,bool? tick,bool? tock,int? split_depth,String? compiler_version,}){
...
ResultOfDecodeStateInit.fromMap(Map<String,dynamic> map){if (map.containsKey('code')&&(map['code']!=null)) {_code = map['code'];}
...
late BocCacheType? _boc_cache;
BocCacheType? get boc_cache => _boc_cache;
ParamsOfEncodeStateInit({String? code,String? data,String? library,bool? tick,bool? tock,int? split_depth,BocCacheType? boc_cache,}){
...
ParamsOfEncodeStateInit.fromMap(Map<String,dynamic> map){if (map.containsKey('code')&&(map['code']!=null)) {_code = map['code'];}
if (map.containsKey('data')&&(map['data']!=null)) {_data = map['data'];}
if (map.containsKey('library')&&(map['library']!=null)) {_library = map['library'];}
if (map.containsKey('tick')&&(map['tick']!=null)) {_tick = map['tick'];}
if (map.containsKey('tock')&&(map['tock']!=null)) {_tock = map['tock'];}
...
late String? _state_init;
String? get state_init => _state_init;
ResultOfEncodeStateInit({required String state_init,}){

_state_init = ArgumentError.checkNotNull(state_init, 'ResultOfEncodeStateInit state_init');
}
ResultOfEncodeStateInit.fromMap(Map<String,dynamic> map){if (map.containsKey('state_init')&&(map['state_init']!=null)) {_state_init = map['state_init'];}else{throw('Wrong map data');}
}
...
late BocCacheType? _boc_cache;
BocCacheType? get boc_cache => _boc_cache;
ParamsOfEncodeExternalInMessage({String? src,required String dst,String? init,String? body,BocCacheType? boc_cache,}){

_src = src;
_dst = ArgumentError.checkNotNull(dst, 'ParamsOfEncodeExternalInMessage dst');
_init = init;
_body = body;
_boc_cache = boc_cache;
}
ParamsOfEncodeExternalInMessage.fromMap(Map<String,dynamic> map){if (map.containsKey('src')&&(map['src']!=null)) {_src = map['src'];}
...
if (map.containsKey('body')&&(map['body']!=null)) {_body = map['body'];}
if (map.containsKey('boc_cache')&&(map['boc_cache']!=null)) {_boc_cache = BocCacheType.fromMap(map['boc_cache']);}
}
...
ResultOfEncodeExternalInMessage({required String message,required String message_id,}){

_message = ArgumentError.checkNotNull(message, 'ResultOfEncodeExternalInMessage message');
_message_id = ArgumentError.checkNotNull(message_id, 'ResultOfEncodeExternalInMessage message_id');
}
ResultOfEncodeExternalInMessage.fromMap(Map<String,dynamic> map){if (map.containsKey('message')&&(map['message']!=null)) {_message = map['message'];}else{throw('Wrong map data');}
