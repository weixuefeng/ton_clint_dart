...
final res = await _tonCore.request('boc.parse_transaction',params.toString());
 return ResultOfParse.fromMap(res);}
...
final res = await _tonCore.request('boc.parse_shardstate',params.toString());
 return ResultOfParse.fromMap(res);}
///Extract blockchain configuration from key block and also from zerostate.
Future<ResultOfGetBlockchainConfig> get_blockchain_config(ParamsOfGetBlockchainConfig params) async {
final res = await _tonCore.request('boc.get_blockchain_config',params.toString());
...
Future<ResultOfGetCodeFromTvc> get_code_from_tvc(ParamsOfGetCodeFromTvc params) async {
final res = await _tonCore.request('boc.get_code_from_tvc',params.toString());
...
Future<ResultOfDecodeStateInit> decode_state_init(ParamsOfDecodeStateInit params) async {
final res = await _tonCore.request('boc.decode_state_init',params.toString());
...
Future<ResultOfEncodeStateInit> encode_state_init(ParamsOfEncodeStateInit params) async {
final res = await _tonCore.request('boc.encode_state_init',params.toString());
 return ResultOfEncodeStateInit.fromMap(res);}
///Allows to encode any external inbound message.
Future<ResultOfEncodeExternalInMessage> encode_external_in_message(ParamsOfEncodeExternalInMessage params) async {
final res = await _tonCore.request('boc.encode_external_in_message',params.toString());
 return ResultOfEncodeExternalInMessage.fromMap(res);}
///Returns the compiler version used to compile the code.
Future<ResultOfGetCompilerVersion> get_compiler_version(ParamsOfGetCompilerVersion params) async {
final res = await _tonCore.request('boc.get_compiler_version',params.toString());
